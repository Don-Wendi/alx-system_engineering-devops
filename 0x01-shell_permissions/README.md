...
Through this project, I gained knowledge of how to represent and modify Linux file permissions as well as switch users in the Shell using the commands `chmod`, `sudo`, `su` ,`chown`, and `chgrp.`
...
* **15. Symbolic links**
  * [101-symbolic_link_permissions](./15-symbolic_link_permissions): Bash script that changes
...
* **17. Star Wars**
  * [103-Star_Wars](./100-Star_Wars): Bash script that plays Star Wars Episode IV
  in the terminal.